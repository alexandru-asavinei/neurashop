...
export default function MobileNav() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 max-w-md mx-auto bg-surface border-t border-border flex justify-around py-3 z-50">
      ...
      <Link href="/">
        <button className="text-sm text-secondary cursor-pointer hover:text-black transition active:scale-95">
          Home
        </button>
      </Link>
      ...
      <Link href="/cart">
        <div className="relative cursor-pointer">
          <button className="text-sm text-secondary hover:text-black transition active:scale-95">
            Cart
          </button>
